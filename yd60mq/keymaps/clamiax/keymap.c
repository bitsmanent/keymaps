...
[1] = LAYOUT_60_ansi(
        ...
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_HOME, KC_PGUP,   _______, _______, _______,    _______,
        _______, _______, _______, _______, BL_DEC,  BL_TOGG, BL_INC,  KC_END,  KC_PGDOWN, _______, _______,         _______,
